<?php
/*
Based on Really Simple CAPTCHA 1.8.0.1
...
if ( ! class_exists( 'SwiftyCaptcha' ) ) {
    ...
    class SwiftyCaptcha
    {
        ...
        public function __construct()
        {
            ...
            $this->fonts = array(
                dirname( __FILE__ ) . '/SwiftyCaptchaB.ttf',
                dirname( __FILE__ ) . '/SwiftyCaptchaBI.ttf',
                dirname( __FILE__ ) . '/SwiftyCaptchaI.ttf',
                dirname( __FILE__ ) . '/SwiftyCaptchaR.ttf' );
